import type { CreateTeamPayload, GetUserTeamsRes, JoinTeamPayload, LeaveTeamPayload, TeamModel, CreateEventRequest, CreateEventResponse, GetTeamEventsResponse } from "@/types/team";
...
export const teamApi = {
  ...
  getTeam: async (teamId: string): Promise<GetTeamResponse> => {
    ...
    if (import.meta.env.DEV && localStorage.getItem("showMockData") === "true") {
      console.log("Using mock data for team API");
      ...
      return {
        team: {
          ...
          member_ids: [
            ...
            "507f1f77bcf86cd799439014", "507f1f77bcf86cd799439015", "507f1f77bcf86cd799439016",
            "507f1f77bcf86cd799439017", "507f1fbccf86cd799439018", "507f1fbccf86cd799439019",
            "507f1fbccf86cd799439020", "507f1fbccf86cd799439021", "507f1fbccf86cd799439022"
          ],
          exec_member_ids: ["507f1f77bcf86cd799439011", "507f1f77bcf86cd799439012"],
          project_ids: [],
          kanban_ids: [],
          event_ids: []
        }
    ...
    console.log("Using real API for team");
  ...
  deleteEvent: async (teamId: string, eventId: string): Promise<void> => {
    await apiClient.post(`/teams/delete-event/${teamId}`, { event_id: eventId });
  },
